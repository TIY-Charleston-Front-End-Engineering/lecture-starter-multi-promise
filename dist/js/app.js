...
var fetchLegislatorPromise = _jquery2.default.getJSON('https://congress.api.sunlightfoundation.com/legislators?bioguide_id=' + congressPersonId);
var fetchCommitteePromise = _jquery2.default.getJSON('https://congress.api.sunlightfoundation.com/committees?member_ids=' + congressPersonId);

_jquery2.default.when(fetchLegislatorPromise, fetchCommitteePromise).then(function (legislatorData, committeeData) {
